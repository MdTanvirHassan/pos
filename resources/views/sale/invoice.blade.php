...
<body >
    <page size="A4" layout="portrait">
        <div style="width: 21cm; padding:50px 30px; margin: 0 auto; border:1px solid #ccc; height:100%;" >
            ...
            <div id="receipt-data" >
                <div class="centered">
                    ...
                    <img src="{{url('public/logo', $general_setting->site_logo)}}" height="60" width="100px" style="margin:10px 0;">
                    @endif
                ...
                <p style="width: 50%; float:left;">
                    ...
                    {{trans('Name')}}: {{$lims_customer_data->name}}<br>
                    {{trans('Phone')}}: {{$lims_customer_data->phone_number}}<br>
                    {{trans('Address')}}: {{$lims_customer_data->address}}
                </p>
                <p style="width: 50%; float:right; text-align:right;">
                    {{trans('file.Date')}}: {{date($general_setting->date_format, strtotime($lims_sale_data->created_at->toDateString()))}}<br>
                    {{$lims_sale_data->reference_no}}<br>
                </p>
                <table class="table-data table-bordered">
                    <thead>
                     <th style="width:400px; text-align:left; display:inline-block;">Product Name</th>
                     <th style="width:70px; text-align:right;">Quantity</th>
                     <th style="width:200px; text-align:right; display: inline-block;">Quty*Price</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:50px; text-align:right;">{{$product_sale_data->qty}}</td>
                            <td style="width:200px; text-align:right; display: inline-block;"">{{$product_sale_data->qty}} x {{number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')}}</td>
                            <td style="text-align:right; width:100px; vertical-align:bottom">{{number_format((float)$product_sale_data->total, 2, '.', '')}}</td>
